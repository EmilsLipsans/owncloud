...
def gui_tests(ctx, trigger = {}, depends_on = [], filterTags = [], version = "daily-master-qa"):
    ...
    build_dir = "build-" + pipeline_name
    squish_parameters = "--retry 1 --reportgen html,%s --envvar QT_LOGGING_RULES=sync.httplogger=true;gui.socketapi=false --envvar LC_TIME=de_DE.UTF-8 --tags ~@skip" % GUI_TEST_REPORT_DIR
